...
class RegisterScreenFormProvidersWidget extends StatelessWidget {
  RegisterScreenFormProvidersWidget({
    super.key,
    this.registerCompanyManagedUser = false,
    this.defaultInputColor = AppColors.green2,
    this.showAsDialog = false,
  });

  final bool registerCompanyManagedUser;
                  ...
                  onPressed: () {
                    if (_formKey.currentState?.saveAndValidate() ?? false) {
                      context
                          ...
                          .registerProvider(_formKey.currentState!.value);
                    }
                  },
                ),
              ),
    ...
    return Column(
      ...
      children: [
        ...
        AppWidgets.defaultFormBuilderDropdown(
          ...
          borderColor: defaultInputColor,
          dropdownColor: defaultInputColor != AppColors.green2 ? AppColors.white : null,
        ),
        ...
        AppWidgets.defaultIconButtonMediaChooser(
          ...
          validator: registerCompanyManagedUser
              ? null
              : FormBuilderValidators.required(),
          color: defaultInputColor,
        ),
      ...
      return Column(
        ...
        children: [
          AppWidgets.defaultFormBuilderDropdown(
            name: 'user_role',
            label: 'User role',
            items: UserRole.companyManagedRoles.map((role) {
    ...
    return Column(
      ...
      children: [
        ...
        FormBuilderRadioGroup<CompanyType>(
          ...
          onChanged: (selected) {
            _formKey.currentState?.fields['sec_number_visibility']
        ...
        Center(
          child: AppWidgets.defaultIconButtonMediaChooser(
            context,
            name: 'company_logo',
            label: 'Company logo',
            svgLogoPath: 'svg/profile_picture_upload.svg',
    ...
    return Column(
      ...
      children: [
        ...
        AppWidgets.defaultFormBuilderDropdown(
          ...
          enabled: !registerCompanyManagedUser,
          initialValue: EmploymentStatus.employed,
        ...
        AppWidgets.defaultFormBuilderTextField(
          ...
          label: 'Salary days',
          enabled: !registerCompanyManagedUser,
          initialValue: user?.employmentDetails.salaryDays.join(','),
          helperText:
