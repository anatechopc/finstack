...
Loooans! -- Your loans marketplace
...
_\*Loooans works on iOS, Android, Web, and Windows._
...
To deploy Firestore indexes, use the `deploy-indexes.sh` script.
...
$ ./scripts/deploy-indexes.sh dev

# Deploy to staging
$ ./scripts/deploy-indexes.sh stg
