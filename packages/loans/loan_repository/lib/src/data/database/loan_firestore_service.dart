...
final class LoanFirestoreService extends BaseFirestoreService<LoanEntity> {
  LoanFirestoreService() {
  ...
  @override
  Future<LoanEntity> delete({required LoanEntity data}) async {
  ...
  Future<LoanEntity> get({
    ...
    return LoanEntity.fromJson(doc.data()! as Map<String, dynamic>);
  }

  @override
  Future<LoanEntity> update({required LoanEntity data}) async {
  ...
  Future<List<LoanEntity>> load({
    ...
    return data.docs
        .map(
          (doc) => LoanEntity.fromJson(doc.data()! as Map<String, dynamic>),
        )
        .toList();
  }
      ...
      controller.addStream(
        query.snapshots().map((snapshot) {
          return snapshot.docs
              .map(
                (doc) =>
                    LoanEntity.fromJson(doc.data()! as Map<String, dynamic>),
              )
              .toList();
        }),
      ),
  ...
  @override
  Stream<List<LoanEntity>> get dataStream => controller.stream;
}
