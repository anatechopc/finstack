...
final class ProductFirestoreService
    extends BaseFirestoreService<ProductEntity> {
  ...
  @override
  Future<ProductEntity> add({required ProductEntity data}) async {
    final doc = root.doc();
  ...
  @override
  Future<ProductEntity> delete({required ProductEntity data}) async {
  ...
  @override
  Future<ProductEntity> get({required String id, bool isCache = false}) async {
  ...
  @override
  Future<ProductEntity> update({required ProductEntity data}) async {
  ...
  Future<List<ProductEntity>> load({
    ...
    return data.docs
        .map(
          (doc) => ProductEntity.fromJson(doc.data()! as Map<String, dynamic>),
        )
        .toList();
  }
  ...
  @override
  Stream<List<ProductEntity>> get dataStream => controller.stream;
}
