...
final class TransactionViewFirestoreService
    extends BaseFirestoreService<TransactionViewEntity> {
  TransactionViewFirestoreService() {
  ...
  @override
  String get collectionName => 'transaction_views';

  @override
  Future<TransactionViewEntity> add(
      {required TransactionViewEntity data,}) async {
    final doc = root.doc();
  ...
  @override
  Future<TransactionViewEntity> delete(
      {required TransactionViewEntity data,}) async {
  ...
  @override
  Future<TransactionViewEntity> get(
      {required String id, bool isCache = false,}) async {
    final doc = await root
        .doc(id)
        .get(!isCache ? null : const GetOptions(source: Source.cache));

    return TransactionViewEntity.fromJson(doc.data()! as Map<String, dynamic>);
  }

  @override
  Future<TransactionViewEntity> update(
      {required TransactionViewEntity data,}) async {
  ...
  @override
  Future<List<TransactionViewEntity>> load({
    ...
    return data.docs
        .map(
          (doc) => TransactionViewEntity.fromJson(
  ...
  @override
  Stream<List<TransactionViewEntity>> get dataStream => controller.stream;
}
