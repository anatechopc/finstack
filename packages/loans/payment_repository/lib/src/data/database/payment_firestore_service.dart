...
final class PaymentFirestoreService
    extends BaseFirestoreService<PaymentEntity> {
  ...
  @override
  Future<PaymentEntity> add({required PaymentEntity data}) async {
    final doc = root.doc();
  ...
  @override
  Future<PaymentEntity> delete({required PaymentEntity data}) async {
  ...
  Future<PaymentEntity> get({
    ...
    return PaymentEntity.fromJson(doc.data()! as Map<String, dynamic>);
  }

  @override
  Future<PaymentEntity> update({required PaymentEntity data}) async {
  ...
  Future<List<PaymentEntity>> load({
    ...
    return data.docs
        .map(
          (doc) => PaymentEntity.fromJson(doc.data()! as Map<String, dynamic>),
        )
        .toList();
  }
  ...
  Future<void> loadNext({
    ...
    if (!switchStream) {
      ...
      final mappedData = data.docs
          .map(
            (doc) =>
                PaymentEntity.fromJson(doc.data()! as Map<String, dynamic>),
          )
          .toList();
  ...
  @override
  Stream<List<PaymentEntity>> get dataStream => controller.stream;
}
