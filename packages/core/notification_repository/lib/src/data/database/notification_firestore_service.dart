...
final class NotificationFirestoreService
    extends BaseFirestoreService<NotificationEntity> {
  ...
  @override
  Future<NotificationEntity> add({required NotificationEntity data}) async {
    final doc = root.doc();
  ...
  @override
  Future<NotificationEntity> delete({required NotificationEntity data}) async {
  ...
  Future<NotificationEntity> get({
    ...
    return NotificationEntity.fromJson(doc.data()! as Map<String, dynamic>);
  }

  @override
  Future<NotificationEntity> update({required NotificationEntity data}) async {
  ...
  @override
  Future<List<NotificationEntity>> load({
    ...
    return data.docs
        .map(
          (doc) =>
              NotificationEntity.fromJson(doc.data()! as Map<String, dynamic>),
        )
        .toList();
  }
  ...
  Future<void> loadNext({
    ...
    if (!switchStream) {
      ...
      final mappedData = data.docs
          .map(
            (doc) => NotificationEntity.fromJson(
  ...
  @override
  Stream<List<NotificationEntity>> get dataStream => controller.stream;
}
